...
@Api(value = "/BMGF_Investments/Strategy", description = "Exposes APIs to work with Strategy resource.")
...
public class StrategyController {
    ...
    public Strategy getStrategy(@PathVariable("id") String id) throws EntityNotFoundException {
    ...
    public boolean deleteStrategy(@PathVariable("id") String id) throws EntityNotFoundException {
    ...
    public Strategy editStrategy(@PathVariable("id") String id, @RequestBody Strategy instance) throws EntityNotFoundException {
