...
@Api(value = "/BMGF_Investments/InvestmentAttributeCode", description = "Exposes APIs to work with InvestmentAttributeCode resource.")
...
public class InvestmentAttributeCodeController {
    ...
    public InvestmentAttributeCode getInvestmentAttributeCode(@PathVariable("id") String id) throws EntityNotFoundException {
    ...
    public boolean deleteInvestmentAttributeCode(@PathVariable("id") String id) throws EntityNotFoundException {
    ...
    public InvestmentAttributeCode editInvestmentAttributeCode(@PathVariable("id") String id, @RequestBody InvestmentAttributeCode instance) throws EntityNotFoundException {
