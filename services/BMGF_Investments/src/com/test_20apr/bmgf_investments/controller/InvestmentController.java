...
@Api(value = "/BMGF_Investments/Investment", description = "Exposes APIs to work with Investment resource.")
...
public class InvestmentController {
    ...
    public Investment getInvestment(@PathVariable("id") String id) throws EntityNotFoundException {
    ...
    public boolean deleteInvestment(@PathVariable("id") String id) throws EntityNotFoundException {
    ...
    public Investment editInvestment(@PathVariable("id") String id, @RequestBody Investment instance) throws EntityNotFoundException {
