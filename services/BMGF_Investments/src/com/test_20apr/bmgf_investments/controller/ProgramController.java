...
@Api(value = "/BMGF_Investments/Program", description = "Exposes APIs to work with Program resource.")
...
public class ProgramController {
    ...
    public Program getProgram(@PathVariable("id") String id) throws EntityNotFoundException {
    ...
    public boolean deleteProgram(@PathVariable("id") String id) throws EntityNotFoundException {
    ...
    public Program editProgram(@PathVariable("id") String id, @RequestBody Program instance) throws EntityNotFoundException {
