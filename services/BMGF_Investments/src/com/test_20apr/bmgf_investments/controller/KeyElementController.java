...
@RestController(value = "BMGF_Investments.KeyElementController")
@Api(value = "/BMGF_Investments/KeyElement", description = "Exposes APIs to work with KeyElement resource.")
@RequestMapping("/BMGF_Investments/KeyElement")
public class KeyElementController {
    ...
    public KeyElement getKeyElement(@PathVariable("id") String id) throws EntityNotFoundException {
    ...
    public boolean deleteKeyElement(@PathVariable("id") String id) throws EntityNotFoundException {
    ...
    public KeyElement editKeyElement(@PathVariable("id") String id, @RequestBody KeyElement instance) throws EntityNotFoundException {
