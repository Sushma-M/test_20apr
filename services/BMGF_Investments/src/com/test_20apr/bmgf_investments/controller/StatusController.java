...
import com.test_20apr.bmgf_investments.service.StatusService;
...
@RestController(value = "BMGF_Investments.StatusController")
@Api(value = "/BMGF_Investments/Status", description = "Exposes APIs to work with Status resource.")
@RequestMapping("/BMGF_Investments/Status")
public class StatusController {

    private static final Logger LOGGER = LoggerFactory.getLogger(StatusController.class);

	@Autowired
	@Qualifier("BMGF_Investments.StatusService")
    ...
    public Status getStatus(@PathVariable("id") String id) throws EntityNotFoundException {
    ...
    public boolean deleteStatus(@PathVariable("id") String id) throws EntityNotFoundException {
    ...
    public Status editStatus(@PathVariable("id") String id, @RequestBody Status instance) throws EntityNotFoundException {
