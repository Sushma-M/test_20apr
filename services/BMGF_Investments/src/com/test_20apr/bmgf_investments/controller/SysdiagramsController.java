...
@Api(value = "/BMGF_Investments/Sysdiagrams", description = "Exposes APIs to work with Sysdiagrams resource.")
...
public class SysdiagramsController {
    ...
    public Sysdiagrams getSysdiagrams(@PathVariable("id") Integer id) throws EntityNotFoundException {
    ...
    public boolean deleteSysdiagrams(@PathVariable("id") Integer id) throws EntityNotFoundException {
    ...
    public Sysdiagrams editSysdiagrams(@PathVariable("id") Integer id, @RequestBody Sysdiagrams instance) throws EntityNotFoundException {
    ...
    public Sysdiagrams editSysdiagrams(@PathVariable("id") Integer id, MultipartHttpServletRequest multipartHttpServletRequest) throws EntityNotFoundException {
