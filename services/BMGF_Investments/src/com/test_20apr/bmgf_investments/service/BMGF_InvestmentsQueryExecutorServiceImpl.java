...
@Service
public class BMGF_InvestmentsQueryExecutorServiceImpl implements BMGF_InvestmentsQueryExecutorService {
	private static final Logger LOGGER = LoggerFactory.getLogger(BMGF_InvestmentsQueryExecutorServiceImpl.class);

	@Autowired
	@Qualifier("BMGF_InvestmentsWMQueryExecutor")
