...
@Service
public class DBtest123QueryExecutorServiceImpl implements DBtest123QueryExecutorService {
	private static final Logger LOGGER = LoggerFactory.getLogger(DBtest123QueryExecutorServiceImpl.class);

	@Autowired
	@Qualifier("DBtest123WMQueryExecutor")
