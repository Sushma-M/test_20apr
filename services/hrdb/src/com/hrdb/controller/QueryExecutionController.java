...
public class QueryExecutionController {
    ...
    @RequestMapping(value = "/queries/SV_Department", method = RequestMethod.GET)
    public Page<Object> executeSV_Department(Pageable pageable) {
        LOGGER.debug("Executing named query SV_Department");
        Page<Object> result = queryService.executeSV_Department(pageable);
