...
import com.test_20apr.db123testing.service.Table3Service;
import java.io.*;
 ...
 */
@RestController(value = "DB123Testing.Table3Controller")
@RequestMapping("/DB123Testing/Table3")
...
public class Table3Controller {
    ...
    @Autowired
    @Qualifier("DB123Testing.Table3Service")
