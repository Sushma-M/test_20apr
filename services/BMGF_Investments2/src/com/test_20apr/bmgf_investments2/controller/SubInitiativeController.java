...
import com.test_20apr.bmgf_investments2.service.SubInitiativeService;
import java.io.*;
 ...
 */
@RestController(value = "BMGF_Investments2.SubInitiativeController")
@RequestMapping("/BMGF_Investments2/SubInitiative")
@Api(description = "Exposes APIs to work with SubInitiative resource.", value = "SubInitiativeController")
public class SubInitiativeController {
    ...
    @Autowired
    @Qualifier("BMGF_Investments2.SubInitiativeService")
    ...
    public SubInitiative getSubInitiative(@PathVariable(value = "id") String id) throws EntityNotFoundException {
    ...
    public SubInitiative editSubInitiative(@PathVariable(value = "id") String id, @RequestBody SubInitiative instance) throws EntityNotFoundException {
    ...
    public boolean deleteSubInitiative(@PathVariable(value = "id") String id) throws EntityNotFoundException {
