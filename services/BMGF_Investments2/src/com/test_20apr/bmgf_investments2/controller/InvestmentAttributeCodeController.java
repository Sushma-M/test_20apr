...
import com.test_20apr.bmgf_investments2.service.InvestmentAttributeCodeService;
import java.io.*;
 ...
 */
@RestController(value = "BMGF_Investments2.InvestmentAttributeCodeController")
@RequestMapping("/BMGF_Investments2/InvestmentAttributeCode")
...
public class InvestmentAttributeCodeController {
    ...
    @Autowired
    @Qualifier("BMGF_Investments2.InvestmentAttributeCodeService")
