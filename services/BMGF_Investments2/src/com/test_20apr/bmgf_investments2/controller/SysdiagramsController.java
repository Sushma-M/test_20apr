...
import com.test_20apr.bmgf_investments2.service.SysdiagramsService;
import java.io.*;
 ...
 */
@RestController(value = "BMGF_Investments2.SysdiagramsController")
@RequestMapping("/BMGF_Investments2/Sysdiagrams")
...
public class SysdiagramsController {
    ...
    @Autowired
    @Qualifier("BMGF_Investments2.SysdiagramsService")
    ...
    public Sysdiagrams createSysdiagrams(MultipartHttpServletRequest multipartHttpServletRequest) {
        Sysdiagrams sysdiagrams = WMMultipartUtils.toObject(multipartHttpServletRequest, Sysdiagrams.class, "BMGF_Investments2");
    ...
    public Sysdiagrams editSysdiagrams(@PathVariable(value = "id") Integer id, MultipartHttpServletRequest multipartHttpServletRequest) throws EntityNotFoundException {
        Sysdiagrams newsysdiagrams = WMMultipartUtils.toObject(multipartHttpServletRequest, Sysdiagrams.class, "BMGF_Investments2");
