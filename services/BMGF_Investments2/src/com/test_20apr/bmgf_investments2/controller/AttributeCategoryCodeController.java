...
import com.test_20apr.bmgf_investments2.service.AttributeCategoryCodeService;
import java.io.*;
 ...
 */
@RestController(value = "BMGF_Investments2.AttributeCategoryCodeController")
@RequestMapping("/BMGF_Investments2/AttributeCategoryCode")
@Api(description = "Exposes APIs to work with AttributeCategoryCode resource.", value = "AttributeCategoryCodeController")
public class AttributeCategoryCodeController {
    ...
    @Autowired
    @Qualifier("BMGF_Investments2.AttributeCategoryCodeService")
    ...
    public AttributeCategoryCode getAttributeCategoryCode(@PathVariable(value = "id") String id) throws EntityNotFoundException {
    ...
    public AttributeCategoryCode editAttributeCategoryCode(@PathVariable(value = "id") String id, @RequestBody AttributeCategoryCode instance) throws EntityNotFoundException {
    ...
    public boolean deleteAttributeCategoryCode(@PathVariable(value = "id") String id) throws EntityNotFoundException {
